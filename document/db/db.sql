...
insert  into `lvyecms_guanlituandui_data`(`id`,`content`,`template`,`paytype`,`allow_comment`) values (1,'DVD发v','',0,0);
...
insert  into `lvyecms_jiejuefangan_data`(`id`,`content`,`template`,`paytype`,`allow_comment`,`relation`) values (1,'C','',0,0,'2|2,1');
...
insert  into `lvyecms_loginlog`(`id`,`username`,`logintime`,`loginip`,`status`,`password`,`info`) values (1,'admin',1492422747,'0.0.0.0',1,'密码保密','用户名登录'),(2,'admin',1492425449,'0.0.0.0',1,'密码保密','用户名登录'),(3,'admin',1492442247,'0.0.0.0',1,'密码保密','用户名登录');
...
insert  into `lvyecms_user`(`id`,`username`,`nickname`,`password`,`bind_account`,`last_login_time`,`last_login_ip`,`verify`,`email`,`remark`,`create_time`,`update_time`,`status`,`role_id`,`info`) values (1,'admin','未知','9edc12391143c2ac219852a87db354f9','',1492442247,'0.0.0.0','L2JgdO','admin@abc3210.com','备注信息',1492422653,1492422653,1,1,'');
