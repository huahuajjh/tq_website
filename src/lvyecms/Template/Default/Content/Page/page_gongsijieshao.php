...
<main>
    ...
    <div class="guide_warp">
        <div class="container">
            ...
            <div id="guide_scr" class="owl-carousel">
                <div class="item"><a href="{:U('lists', array('catid'=>13))}" class="guide_cur"><span>{:getCategory(13,'catname')}</span></a></div>
    ...
    <div class="container-text">
        <!--intro begin-->
        <div id="content"><textarea style="display:none;">{:getCustomData(7)}</textarea></div>
        <!--intro end-->
    </div>
    <!--container end-->
</main>
